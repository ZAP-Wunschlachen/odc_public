...
UI_TESTS = {'test_axis_modal', 'test_margin_modal', 'test_curve_manager', 'test_overlay_gpu', 'test_implant_views', 'test_bridge_modal', 'test_root_modal', 'test_label_modal', 'test_bracket_manager', 'test_bracket_modal'}
