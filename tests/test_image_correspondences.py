...
warnings=[]
state=SimpleNamespace(imgeditor_area=SimpleNamespace(spaces=SimpleNamespace(active=SimpleNamespace(image=bpy.data.images.new('Correspondence image',width=800,height=600)))),points_3d=list(map(Vector,points)),pixel_coords=list(map(Vector,pixels)),
